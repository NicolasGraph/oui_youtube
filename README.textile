...
"oui_player_youtube":https://github.com/NicolasGraph/oui_player_youtube is a "oui_player":https://github.com/NicolasGraph/oui_player v2+ extension to easily embed "YouTube":https://youtube.com/ provided videos in "Textpattern":https://textpattern.com/ powered websites.
...
oui_player_youtube's minimum requirements:
...
# "Download":https://github.com/NicolasGraph/oui_player_youtube/releases the compiled plugin file or the source to compile a customized file.
...
# Install oui_player_youtube:
@$ composer require oui/oui_player_youtube@
...
bc. $ composer update oui/oui_player_youtube
...
bc. $ composer remove oui/oui_player_youtube
...
oui_player_youtube version 1.0.0, Copyright (C) 2018 Nicolas Morand
...
* *oui_player_youtube v1.0.0-beta* (2018-06-24)
